...
func (m *Group) validate(all bool) error {
	...
	for idx, item := range m.GetTssGroups() {
		_, _ = idx, item
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, GroupValidationError{
						field:  fmt.Sprintf("TssGroups[%v]", idx),
...
// Validate checks the field values on TssGroup with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *TssGroup) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on TssGroup with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in TssGroupMultiError, or nil
// if none found.
func (m *TssGroup) ValidateAll() error {
	return m.validate(true)
}

func (m *TssGroup) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	// no validation rules for TssGroupId

	// no validation rules for Curve

	// no validation rules for Pubkey

	if len(errors) > 0 {
		return TssGroupMultiError(errors)
	}

	return nil
}

// TssGroupMultiError is an error wrapping multiple validation errors returned
// by TssGroup.ValidateAll() if the designated constraints aren't met.
type TssGroupMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m TssGroupMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m TssGroupMultiError) AllErrors() []error { return m }

// TssGroupValidationError is the validation error returned by
// TssGroup.Validate if the designated constraints aren't met.
type TssGroupValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e TssGroupValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e TssGroupValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e TssGroupValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e TssGroupValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e TssGroupValidationError) ErrorName() string { return "TssGroupValidationError" }

// Error satisfies the builtin error interface
func (e TssGroupValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = TssGroupValidationError{}
